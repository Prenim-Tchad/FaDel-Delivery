...
export class CacheService {
  ...
  async setPopularRestaurants(restaurants: any[], ttlSeconds: number = 600): Promise<void> {
  ...
  async setRestaurantMenu(restaurantId: string, menu: any, ttlSeconds: number = 300): Promise<void> {
  ...
  async setRestaurantReviews(restaurantId: string, reviews: any[], ttlSeconds: number = 300): Promise<void> {
  ...
  async setDeliveryZones(restaurantId: string, zones: any[], ttlSeconds: number = 3600): Promise<void> {
  ...
  async setValidPromoCodes(codes: any[], ttlSeconds: number = 1800): Promise<void> {
  ...
  async setRestaurantStats(restaurantId: string, stats: any, ttlSeconds: number = 600): Promise<void> {
  ...
  async setWithTags<T>(key: string, data: T, tags: string[], ttlSeconds: number = 300): Promise<void> {
    // Stocker les données
