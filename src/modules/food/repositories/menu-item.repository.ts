...
export class MenuItemRepository {
  ...
  /**
   * Met à jour l'URL de la photo d'un article
   */
  async updatePhoto(
    id: string,
    imageUrl: string,
  ...
  /**
   *  TÂCHE #36 : Ajoute un groupe d'options (ex: Tailles) avec ses choix
   */
  async addOptionGroup(menuItemId: string, dto: CreateOptionGroupDto) {
    return await this.prisma.menuModifierGroup.create({
      data: {
        menuItemId,
        name: dto.name,
        description: dto.description,
