...
export class CreatePromoCodeDto {
  ...
  @ApiProperty({
    description: 'Nom du code promo',
    example: 'Remise de bienvenue',
  })
  @IsString()
  name: string;
  ...
  @ApiProperty({
    ...
    example: '10% de réduction sur la première commande',
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description: 'Commande minimum requise pour appliquer le code',
    example: 2000,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Réduction maximale pour un code pourcentage',
    example: 1500,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Liste des restaurants applicables',
    example: ['rest1', 'rest2'],
    required: false,
    type: [String],
  })
  ...
  @ApiProperty({
    description: 'Liste des catégories applicables',
    example: ['cat1', 'cat2'],
    required: false,
    type: [String],
  })
