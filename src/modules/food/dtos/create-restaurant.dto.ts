...
export class CreateRestaurantDto {
  ...
  @ApiProperty({
    ...
    example: 'https://lacasa.example.com',
    required: false,
  })
  @IsOptional()
  @IsUrl()
  ...
  @ApiProperty({
    ...
    example: 'https://lacasa.example.com/logo.png',
    required: false,
  })
  @IsOptional()
  @IsUrl()
  ...
  @ApiProperty({
    ...
    example: 'https://lacasa.example.com/cover.jpg',
    required: false,
  })
  @IsOptional()
  @IsUrl()
  ...
  @ApiProperty({
    description: 'Frais de livraison en CFA',
    example: 500,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Montant de commande minimum en CFA',
    example: 2000,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Délai estimé de livraison en minutes',
    example: 35,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Fuseau horaire du restaurant',
  ...
  @ApiProperty({
    description: 'ID de la catégorie de cuisine',
    example: 'ckabc123',
    required: false,
  })
  @IsNotEmpty()
  ...
  @ApiProperty({
    ...
    example: [{ name: 'Centre-ville', deliveryFee: 300 }],
    required: false,
    type: [Object],
  })
  @IsOptional()
